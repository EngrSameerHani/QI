...
const Footer = () => {
  ...
  <ul className="list-unstyled">
  <li>
    <Link className="text-white" href="/consultants">
      Consultants
    </Link>
  </li>
  ...
  <li>
    <Link className="text-white" href="/career/positions">
      Career
    </Link>
  </li>

  <li>
    <Link className="text-white" href="/#latestNews">
      Latest News
    </Link>
  </li>

  <li>
    <Link className="text-white" href="/make-appointment">
      Appointments
    </Link>
  </li>
  ...
  <li>
    <Link className="text-white" href="/about-us/highlights">
      Highlights
    </Link>
  </li>
</ul>
  ...
  <p className="text-white">
    Quaid-e-Azam International Hospital, Near Golra Morr, Peshawar Road,
    Islamabad, Pakistan
  </p>
